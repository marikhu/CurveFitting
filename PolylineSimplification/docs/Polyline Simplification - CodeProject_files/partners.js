...
_oiqq.push(['oiq_addPageCat','Computers']);
...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=codeproject.com&AYAH_P2=9581eb2a-e4fb-4fbe-9aae-07ce4e51aa1e&AYAH_F1=Lotame';
  ...
  var bkInt = setInterval(function(){
    if(document.body){
      ...
      bksrc.onload = function() {
                ...
                bk_addPageCtx("sh001", "24816674");
                bk_addPageCtx("sh004", "10813337");
                bk_addPageCtx("sh004", "10813313");
